...
def parse_args():
    ...
    parser.add_argument('--layers', nargs='?', default='[64,32,16,8,4]',
    ...
    parser.add_argument('--mf_pretrain', nargs='?', default='Pretrain/lastfm_GMF_4_1606534831.h5',
                        help='Specify the pretrain model file for MF part. If empty, no pretrain will be used')
    parser.add_argument('--mlp_pretrain', nargs='?', default='Pretrain/lastfm_MLP_[64,32,16,8,4]_1606539024.h5',
