...
def parse_args():
    ...
    parser.add_argument('--mf_pretrain', nargs='?', default='Pretrain/lastfm_GMF_8_1604571901.h5',
...
if __name__ == '__main__':
    ...
    model_out_file = 'Pretrain/%s_DeepCF_%d_%s_%d.h5' % (args.dataset, mf_dim, args.layers, time())
